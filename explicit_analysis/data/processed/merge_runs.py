...
def merge_append_and_plot():
    ...
    df1 = pd.read_csv("explicit_analysis/data/processed/scoring_processed_run_1.csv")
    df1["Run"] = "Run 1"
    df2 = pd.read_csv("explicit_analysis/data/processed/scoring_processed_run_2.csv")
    df2["Run"] = "Run 2"
    df3 = pd.read_csv("explicit_analysis/data/processed/scoring_processed_run_3.csv")
    df3["Run"] = "Run 3"
    ...
    merged_csv_path = "explicit_analysis/data/processed/scoring_processed_combined.csv"
