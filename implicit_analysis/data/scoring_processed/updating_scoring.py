...
def main():
    ...
    input_csv = "implicit_analysis/data/scoring_processed/scoring_processed_run_2_3.csv"
    output_csv = "implicit_analysis/data/scoring_processed/scoring_processed_run_2_3_test.csv"
